...
<body>
    ...
    <div class="col-md-12 col-sm-6 col-xs-12 lyt-left">
        <div class="input-box leave-ib">
            ...
            <span style="font-size:11px; color:red">Password should contain at least one number, one uppercase and lowercase letter, and be at least 6 characters long</span>
        </div>
    </div>
