...
if(isset($_POST['signin']))
{
    ...
    if($query->rowCount() > 0)
    {
        foreach ($results as $result) {
            ...
            $_SESSION['role'] = $result->role; // Store the user's role in the session
        } 
        ...
        {
            // Check if the user role is 'Venu' and redirect accordingly
            if ($_SESSION['role'] == 'Venu') {
                header("Location: venu/index.php");
                exit();
            } else {
