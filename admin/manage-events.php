...
<body>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <table width="100%" class="table table-striped table-bordered table-hover"
                                        ...
                                        <tbody>
    <?php
    $sql = "SELECT  tblevents.id as eid,tblevents.EventName,tblevents.EventStartDate,tblevents.EventEndDate,tblcategory.CategoryName, tblevents.IsActive FROM tblevents JOIN tblcategory ON tblcategory.id=tblevents.CategoryId";
    ...
    <?php if ($row->IsActive == 1) { ?>
        <a href="reject_event.php?sid=<?php echo htmlentities($row->eid); ?>&status=0">
            <button type="button" class="btn btn-info">Reject</button>
        </a>
    <?php } else { ?>
        <a href="reject_event.php?sid=<?php echo htmlentities($row->eid); ?>&status=1">
